...
export const AFRICAN_COUNTRIES = [
  ...
  { code: "BJ", name: "Benin", cities: ["Cotonou", "Porto-Novo", "Parakou", "Djougou"] },
  { code: "BW", name: "Botswana", cities: ["Gaborone", "Francistown", "Maun", "Lobatse"] },
  { code: "BF", name: "Burkina Faso", cities: ["Ouagadougou", "Bobo-Dioulasso", "Koudougou"] },
  { code: "BI", name: "Burundi", cities: ["Gitega", "Bujumbura", "Muyinga", "Ngozi"] },
  { code: "CV", name: "Cabo Verde", cities: ["Praia", "Mindelo", "Santa Maria"] },
  { code: "CM", name: "Cameroon", cities: ["Douala", "Yaounde", "Garoua", "Bamenda"] },
  { code: "CF", name: "Central African Republic", cities: ["Bangui", "Bimbo", "Berberati"] },
  { code: "TD", name: "Chad", cities: ["N'Djamena", "Moundou", "Sarh", "Abeche"] },
  { code: "KM", name: "Comoros", cities: ["Moroni", "Mutsamudu", "Fomboni"] },
  { code: "CD", name: "Democratic Republic of the Congo", cities: ["Kinshasa", "Lubumbashi", "Mbuji-Mayi", "Goma", "Kisangani"] },
  { code: "CG", name: "Republic of the Congo", cities: ["Brazzaville", "Pointe-Noire", "Dolisie"] },
  { code: "CI", name: "Cote d'Ivoire", cities: ["Abidjan", "Yamoussoukro", "Bouake", "Daloa"] },
  { code: "DJ", name: "Djibouti", cities: ["Djibouti City", "Ali Sabieh", "Tadjoura"] },
  { code: "EG", name: "Egypt", cities: ["Cairo", "Alexandria", "Giza", "Shubra El Kheima", "Port Said"] },
  { code: "GQ", name: "Equatorial Guinea", cities: ["Malabo", "Bata", "Ebebiyin"] },
  { code: "ER", name: "Eritrea", cities: ["Asmara", "Keren", "Massawa"] },
  { code: "SZ", name: "Eswatini", cities: ["Mbabane", "Manzini", "Lobamba", "Piggs Peak"] },
  { code: "ET", name: "Ethiopia", cities: ["Addis Ababa", "Dire Dawa", "Gondar", "Mekelle", "Bahir Dar"] },
  { code: "GA", name: "Gabon", cities: ["Libreville", "Port-Gentil", "Franceville"] },
  { code: "GM", name: "Gambia", cities: ["Banjul", "Serekunda", "Brikama"] },
  { code: "GH", name: "Ghana", cities: ["Accra", "Kumasi", "Tamale", "Takoradi", "Tema"] },
  { code: "GN", name: "Guinea", cities: ["Conakry", "Kankan", "Nzerekore", "Kindia"] },
  { code: "GW", name: "Guinea-Bissau", cities: ["Bissau", "Bafata", "Gabú"] },
  { code: "KE", name: "Kenya", cities: ["Nairobi", "Mombasa", "Kisumu", "Nakuru", "Eldoret"] },
  { code: "LS", name: "Lesotho", cities: ["Maseru", "Maputsoe", "Mafeteng", "Teyateyaneng"] },
  ...
  { code: "MG", name: "Madagascar", cities: ["Antananarivo", "Toamasina", "Antsirabe", "Mahajanga"] },
  { code: "MW", name: "Malawi", cities: ["Lilongwe", "Blantyre", "Mzuzu", "Zomba"] },
  { code: "ML", name: "Mali", cities: ["Bamako", "Sikasso", "Mopti", "Koutiala"] },
  { code: "MR", name: "Mauritania", cities: ["Nouakchott", "Nouadhibou", "Kiffa", "M'Bout"] },
  { code: "MU", name: "Mauritius", cities: ["Port Louis", "Beau Bassin-Rose Hill", "Vacoas-Phoenix"] },
  { code: "MA", name: "Morocco", cities: ["Casablanca", "Marrakech", "Rabat", "Fes", "Tangier", "Agadir"] },
  { code: "MZ", name: "Mozambique", cities: ["Maputo", "Beira", "Nampula", "Chimoio", "Nacala"] },
  { code: "NA", name: "Namibia", cities: ["Windhoek", "Walvis Bay", "Swakopmund", "Oshakati"] },
  { code: "NE", name: "Niger", cities: ["Niamey", "Zinder", "Maradi", "Tahoua"] },
  { code: "NG", name: "Nigeria", cities: ["Lagos", "Abuja", "Port Harcourt", "Kano", "Ibadan", "Kaduna"] },
  { code: "RW", name: "Rwanda", cities: ["Kigali", "Gisenyi", "Butare", "Gitarama"] },
  { code: "ST", name: "Sao Tome and Principe", cities: ["Sao Tome", "Trindade", "Neves"] },
  { code: "SN", name: "Senegal", cities: ["Dakar", "Touba", "Thies", "Rufisque", "Kaolack"] },
  { code: "SC", name: "Seychelles", cities: ["Victoria", "Anse Etoile", "Beau Vallon"] },
  { code: "SL", name: "Sierra Leone", cities: ["Freetown", "Bo", "Kenema", "Makeni"] },
  { code: "SO", name: "Somalia", cities: ["Mogadishu", "Hargeisa", "Bosaso", "Galkayo"] },
  { code: "ZA", name: "South Africa", cities: ["Johannesburg", "Cape Town", "Durban", "Pretoria", "Port Elizabeth", "Bloemfontein"] },
  { code: "SS", name: "South Sudan", cities: ["Juba", "Wau", "Malakal", "Yei"] },
  { code: "SD", name: "Sudan", cities: ["Khartoum", "Omdurman", "Khartoum North", "Port Sudan"] },
  { code: "TZ", name: "Tanzania", cities: ["Dar es Salaam", "Arusha", "Dodoma", "Mwanza", "Zanzibar City"] },
  { code: "TG", name: "Togo", cities: ["Lome", "Sokode", "Kara", "Kpalime"] },
  { code: "TN", name: "Tunisia", cities: ["Tunis", "Sfax", "Sousse", "Kairouan"] },
